# Settings_AccountSecurity 页元素索引

- 来源：`Settings_AccountSecurity_window_dump.xml`
- App 版本：3.1.0.7123
- 包名：`com.aeke.fitnessmirror`
- Activity：`com.aeke.fitnessmirror.activity.UserSecurityActivity`
...
| `tvTitle` | Account Security | TextView | 否 | `[351,62][730,127]` |

## 账户安全 · 操作

| resource-id | 文案 | 类型 | 可点 | bounds |
|-------------|------|------|------|--------|
| `ll_change_password` | — | LinearLayout | 是 | `[54,220][1026,364]` |
| — | Change Password | TextView | 否 | `[102,268][363,316]` |
...
| `titleScrollView` | — | HorizontalScrollView | 否 | `[351,62][730,127]` |
