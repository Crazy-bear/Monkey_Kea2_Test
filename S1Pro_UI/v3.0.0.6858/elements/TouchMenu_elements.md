...
|-------------|------|------|------|--------|
| `container_touch_2` | — | ViewGroup | 是 | `[326,560][1026,1120]` |
| `layout_expand` | — | ViewGroup | 否 | `[326,560][1026,1120]` |
| `touch_layout_bg` | — | LinearLayout | 否 | `[368,576][976,1076]` |
| `touch_area` | — | RelativeLayout | 否 | `[368,576][976,628]` |

## 悬浮 Touch · 音乐控制

| resource-id | 文案 | 类型 | 可点 | bounds |
|-------------|------|------|------|--------|
| `float_music_fl` | — | FrameLayout | 否 | `[368,628][656,916]` |
| `float_kugou_music_con` | — | RelativeLayout | 否 | `[368,628][656,916]` |
| `no_kg_play` | Not Playing | TextView | 否 | `[440,753][583,791]` |
| `btn_previous` | — | RelativeLayout | 是 | `[404,832][460,888]` |
| `btn_toggle` | — | RelativeLayout | 是 | `[484,832][540,888]` |
| `toggle_click_img` | — | ImageView | 否 | `[492,840][532,880]` |
| `btn_next` | — | RelativeLayout | 是 | `[564,832][620,888]` |

## 悬浮 Touch · 音量

| resource-id | 文案 | 类型 | 可点 | bounds |
|-------------|------|------|------|--------|
| `seekbar_volume` | — | ViewGroup | 否 | `[688,628][816,916]` |
| `seekbar` | 40.0 | SeekBar | 否 | `[688,628][816,916]` |
| `icon` | — | View | 是 | `[724,836][780,892]` |

## 悬浮 Touch · 快捷操作

| resource-id | 文案 | 类型 | 可点 | bounds |
|-------------|------|------|------|--------|
| `go_back_btn` | — | LinearLayout | 是 | `[848,628][976,756]` |
| — | Fold | TextView | 否 | `[893,710][931,738]` |
| `go_home_btn` | — | LinearLayout | 是 | `[848,788][976,916]` |
| — | Home | TextView | 否 | `[885,870][939,898]` |
...
| resource-id | 文案 | 类型 | 可点 | bounds |
|-------------|------|------|------|--------|
| `bottom_tool_layout` | — | LinearLayout | 否 | `[368,944][976,1076]` |
| `all_tool` | — | LinearLayout | 是 | `[368,948][496,1076]` |
| — | Toolbar | TextView | 否 | `[398,1028][466,1056]` |
| `retrieve_the_rope` | — | LinearLayout | 是 | `[528,948][656,1076]` |
| `retrieve_the_rope_text` | Retract rope | TextView | 否 | `[540,1028][644,1056]` |
| `sleep` | — | LinearLayout | 是 | `[688,948][816,1076]` |
| — | Sleep | TextView | 否 | `[727,1028][777,1056]` |
| `screen` | — | LinearLayout | 是 | `[848,948][976,1076]` |
| — | Wallpaper | TextView | 否 | `[867,1028][957,1056]` |
...
| `top_strip` | 03:27 PM | TextView | 是 | `[470,8][610,61]` |
| — | — | ViewGroup | 是 | `[0,160][1080,660]` |
| — | — | LinearLayout | 是 | `[54,160][129,248]` |
| — | — | LinearLayout | 是 | `[129,160][215,248]` |
| — | — | LinearLayout | 是 | `[215,160][311,248]` |
| — | — | LinearLayout | 是 | `[427,160][498,248]` |
| — | — | LinearLayout | 是 | `[498,160][579,248]` |
| — | — | LinearLayout | 是 | `[579,160][666,248]` |
...
| resource-id | 文案 | 类型 | 可点 | bounds |
|-------------|------|------|------|--------|
| `parent` | — | ViewGroup | 否 | `[688,628][816,916]` |
...
| `tl_days` | — | HorizontalScrollView | 否 | `[54,160][666,248]` |
| `tv_name` | Mon | TextView | 否 | `[54,160][129,222]` |
| `tv_name` | Tue | TextView | 否 | `[129,160][215,222]` |
| `tv_name` | Wed | TextView | 否 | `[215,160][311,222]` |
| `tv_name` | Today | TextView | 否 | `[311,160][427,222]` |
| `tv_name` | Fri | TextView | 否 | `[427,160][498,222]` |
| `tv_name` | Sat | TextView | 否 | `[498,160][579,222]` |
| `tv_name` | Sun | TextView | 否 | `[579,160][666,222]` |
| `hsr_tips` | — | FrameLayout | 否 | `[0,660][1080,760]` |
| — | Today's Effort | TextView | 否 | `[154,688][330,732]` |
| `ctl_report_infos` | — | ViewGroup | 否 | `[695,686][990,734]` |
| `tv_time_length_trans` | 0 | TextView | 否 | `[695,686][717,734]` |
| `tv_time_length` | 0 | TextView | 否 | `[695,686][717,734]` |
| `tv_time_unit` | min | TextView | 否 | `[725,694][766,734]` |
| `tv_kcal_trans` | 0 | TextView | 否 | `[806,686][828,734]` |
| `tv_kcal` | 0 | TextView | 否 | `[806,686][828,734]` |
