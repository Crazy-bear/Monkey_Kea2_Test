# Home_ControlPanel_Volume 页元素索引

- 来源：`Home_ControlPanel_Volume_window_dump.xml`
- App 版本：3.0.0.6858
...
| resource-id | 文案 | 类型 | 可点 | bounds |
|-------------|------|------|------|--------|
| `sys_progress_ll` | — | LinearLayout | 是 | `[354,160][1026,492]` |
| `sys_bar_progress_title` | Volume | TextView | 否 | `[634,200][746,256]` |
| `sb_volum_mute` | — | View | 是 | `[882,200][978,256]` |
...
| `sys_progress_tv` | System | TextView | 否 | `[402,305][538,338]` |
...
| resource-id | 文案 | 类型 | 可点 | bounds |
|-------------|------|------|------|--------|
| `ll_aeke_voice` | — | LinearLayout | 否 | `[402,396][978,452]` |
| `tv_aeke_voice` | AEKE AI | TextView | 否 | `[402,407][538,440]` |
| `v_aeke_seekbar_bottom` | — | View | 否 | `[564,406][972,442]` |
| `asb_aeke_voice_bar` | — | SeekBar | 否 | `[564,406][972,442]` |
| `v_aeke_seekbar_left` | — | View | 否 | `[564,406][600,442]` |
